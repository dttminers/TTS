        ...
        try {
            ...
            if (requestCode == CAMERA_CAPTURE_IMAGE_REQUEST_CODE) {
                if (resultCode == RESULT_OK) {
                    ...
                    CommonMethod.toDisplayToast(getApplicationContext(), "User cancelled image capture");
                    finish();
                } else {
                    // failed to capture image
                    CommonMethod.toDisplayToast(getApplicationContext(), "Sorry! Failed to capture image");
                }
            }
        } catch (Exception | Error e) {
            e.printStackTrace();
...
//            CameraUtils.rotateImageIfRequired(CameraUtils.optimizeBitmap(BITMAP_SAMPLE_SIZE, imageStoragePath), imageStoragePath);
