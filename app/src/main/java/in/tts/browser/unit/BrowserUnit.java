...
public class BrowserUnit {
    ...
    private static final String SEARCH_ENGINE_STARTPAGE = SEARCH_ENGINE_GOOGLE;//"https://startpage.com/do/search?query=";
    ...
    private static final String SEARCH_ENGINE_STARTPAGE_DE = SEARCH_ENGINE_GOOGLE;//"https://startpage.com/do/search?lui=deu&language=deutsch&query=";
