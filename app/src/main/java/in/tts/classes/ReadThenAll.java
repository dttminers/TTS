...
//        Log.d("TAGPPPP", " ReadThenAll : " + numberOfThreads);
...
//        Log.d("TAGPPPP", " File Name " + fileName);
...
//                                Log.d("TAGPPPP", " Name : " + file.getName());
//                                lstfiles.add(file);
//                                lstnams.add(file.getName());
//                                adapter.notifyDataSetChanged();
                                counter++;
                                //put you arraylist here
                            }
                        } else {
